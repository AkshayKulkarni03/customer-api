...
public class CustomerControllerIntegrationTest {
	...
	void testUpdateCustomerAddress() throws Exception {
		mockMvc.perform(patch("/customers/1003").contentType(MediaType.APPLICATION_JSON).content(
				"{ \"street\": \"SOMESTREESAT\", \"houseNumber\": \"4200\", \"city\": \"Amsterdam\", \"zipCode\": \"1980ST\" }"))
				.andDo(print()).andExpect(status().isNoContent());

		mockMvc.perform(patch("/customers/2001").contentType(MediaType.APPLICATION_JSON).content(
				"{ \"street\": \"SOMESTREESAT\", \"houseNumber\": \"4200\", \"city\": \"Amsterdam\", \"zipCode\": \"1980ST\" }"))
