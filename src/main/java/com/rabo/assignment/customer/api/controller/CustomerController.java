...
import com.rabo.assignment.customer.api.util.UniqueIdGenerator;
...
public class CustomerController {
    ...
    public ResponseEntity<List<Customer>> getAllCustomers(@RequestParam(name = "pageNumber", required = false, defaultValue = "0") Integer pageNumber) {
    ...
    public ResponseEntity<Void> updateCustomerAddress(@PathVariable("customerId") Long customerId, @Valid @RequestBody CustomerAddressRequest address) {
